...
class updtxt { 
  ...
  public static void aboutme () throws IOException{
      ...
      System.out.println("|                                          |");
      System.out.println("|  Hello !!! My name is Suriya Phutduang.  |");
      System.out.println("|  My nick name is Nick.                   |");
      System.out.println("|  I'm age 20.                             |");
      System.out.println("|  I'm study Nation University.            |");
      System.out.println("|  My github is Suriya005.                 |");
    ...
    public static void addsub () throws IOException {
      ...
      String b;
      String ar[] = new String[10];
      FileReader fin = new FileReader("sub.txt");
      BufferedReader bin = new BufferedReader (fin);
      int i = 0;
      while ((b =  bin.readLine()) != null) {      
          ar[i] = b; 
      ...
      fin.close();
      int tot = i;
      FileOutputStream fout = new FileOutputStream("sub.txt");
      BufferedOutputStream bout = new BufferedOutputStream(fout);
      PrintStream pout = new PrintStream(bout);
      i = 0;
      while (i < tot) {      
  ...
  public static void addreg () throws IOException {
    ...
    FileReader fin = new FileReader("add.txt");
    BufferedReader bin = new BufferedReader (fin);
    int i = 0;
    while ((b =  bin.readLine()) != null) {      
        ar[i] = b; 
